...
public class SimHash {
    ...
    public BigInteger simHash() {
        ...
        logger.debug(this.strSimHash + " length " + this.strSimHash.length());
        return fingerprint;
    }
    ...
    public static void main(String[] args) {
        ...
        s = "import java.util.Arrays;\n" +
                ...
                "        logger.debug(Arrays.stream(strs).mapToInt(Integer::parseInt).sum());\n" +
                "        }\n" +
                "    }";
    ...
    for (int i = 0; i < str.length(); i++) {
        logger.debug(str.substring(i, i + 1).matches("[\\u4e00-\\u9fbb]+"));
    }*/
