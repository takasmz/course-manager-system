                                ...
                                success:function (result) {
                                    ...
                                    if(result.code == '1' && data.length>0){
                                        for(var i=0 ; i< data.length ; i++){
                                            var html =
                                                '<li class="cl pd-5">'+
                                                '<a title="'+data[i]+'" target="_blank" class="mr-10" href="student/homework/download/'+path+'/'+data[i]+'">'+
                        ...
                        if(data.code=='1'){
                            ...
                            for(var i=0;i<filenames.length-1;i++){
                                var html =
                                    ...
                                    '<a title="'+filename[i]+'" target="_blank" class="mr-10" href="student/homework/download/'+path+'/'+filename[i]+'">'+
                                    ' <i class="layui-icon layui-icon-link"></i>'+
