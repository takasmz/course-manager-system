...
require(deps,
    ...
    function getCourseIntro(courseId,index) {
        $.ajax({
            ...
            type:'post',
            dataType:'json',
            data:{courseId:courseId,type:'intro'},
        ...
        function initEditorMd(courseId) {
            Editor = editormd("editor", {
                ...
                onload : function() {
                    // $(".editormd-preview").find("img").each(function (index,element) {
                    //     var src = $(element).attr("src");
                    //     $(element).attr("src",path + src);
                    // })
                    //this.fullscreen();
            ...
            util.bindEvents([ {
                ...
                handler: function () {
                    ...
                    $.ajax({
                        ...
                        type:'post',
                        dataType:'json',
                        data:{md:md,courseId:courseId,type:'intro'},
