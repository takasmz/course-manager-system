...
Popover = (function(superClass) {
  ...
  Popover.prototype._initLabelWidth = function() {
    ...
    return $fields.find('label').width(this._labelWidth+1);
  };
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $input = $('<input name="files[]" type="file"  multiple=true  accept=image/gif,image/jpeg,image/jpg,image/png,image/svg" />').appendTo($uploadItem);
      };
    })(this);
    createInput();
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input name="files[]" type="file"  multiple:true  accept: "image/gif,image/jpeg,image/jpg,image/png,image/svg"/>').appendTo($uploadBtn);
      };
    })(this);
    createInput();
