define(['jquery', 'jquery.validate'], function () {
     ...
     * 自定义身份证号验证规则（不要修改）2
     */
    $.validator.addMethod('idCards_', function (value, element) {
        //获取certType的值
        var certType = $(element).parent().parent().prev().children("#id_").children("#certType").val();
        if(certType!=1)//当证件类型不为身份证时不判断
            return { result: true};
        var __idNo__ = function (idcard) {
            var area = {
                11: "北京", 12: "天津", 13: "河北", 14: "山西", 15: "内蒙古", 21: "辽宁", 22: "吉林", 23: "黑龙江", 31: "上海", 32: "江苏", 33: "浙江",
