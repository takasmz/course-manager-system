...
;layui.extend({
    setter: "/js/layui/config",
    admin: "/js/layui/lib/admin",
    view: "/js/layui/lib/view",
...
//        	window.reload();
//        }
//         $.getScript("js"+y+".js").done(function() {
//             console.log('success')
//         });;
//         $("#mainJs").attr("src","js"+y+".js");
        r.length || (r = [""]),
      ...
      , r = function(e) {
        ...
        n || "/login" === s)
            ...
            "controller/console" === i.pageType ? o() : r.render("layout").done(function() {
                o(),
      ...
      , d = layui.$
      , c = d(window);
    layui.link("/js/layui/style/admin.css", function() {
        r()
    }, "layuiAdmin"),
...
//    var data = layui.data(a.tableName);
//    var token = a.request.tokenName;
