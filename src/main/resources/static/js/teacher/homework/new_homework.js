            ...
            layui.use(['form','element','laydate'], function(){
                ...
                $(document).on("click",".edit",function () {
                    ...
                    $.ajax({
                        ...
                        success:function (result) {
                            ...
                            data.testCase = 'input:' + data.inputs + '\n' + 'output:' + data.outputs
                ...
                form.on('submit(courseExamSubmit)', function(data){
                    ...
                    $.ajax({
                        ...
                        success:function (result) {
                            if(result.code == 1){
                                layer.msg("作业保存成功",{time:1500,icon:1})
                            }else {
        ...
        function initEditor(obj) {
            ...
            var e = new Simditor({
                ...
                upload : {
                    ...
                    params: {courseExamId:$("#courseExamId").val()}, //键值对,指定文件上传接口的额外参数,上传的时候随文件一起提交
